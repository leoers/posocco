...
const questions = [
  { 
    q: 'Você possui um plano de saúde ativo?', 
    a: '(empresarial ou particular)'
  },
  { 
    q: 'O tratamento ou medicamento foi prescrito pelo seu médico?', 
    a: '(com relatório médico ou receita)'
  },
  { 
    q: 'O plano negou a cobertura (ou demorou para responder)?', 
    a: '(negativa escrita ou silêncio do plano)'
  },
  { 
    q: 'A falta do tratamento está prejudicando a sua saúde ou qualidade de vida?', 
    a: '(urgência ou continuidade do tratamento)'
  }
];
    ...
    <section className="section" style={{ ...styles.section, paddingTop: isMobile ? '60px' : '100px' }}>
      <div className="container">
          ...
          <div style={{ ...styles.grid, flexDirection: isMobile ? 'column' : 'row' }}>
            ...
            {/* Left Column */}
            <div className="animate-fade-up" style={{ ...styles.leftCol, textAlign: isMobile ? 'center' : 'left', alignItems: isMobile ? 'center' : 'flex-start', order: isMobile ? 2 : 1 }}>
              ...
              <p className="text-muted" style={{ marginTop: isMobile ? '0' : '16px', fontSize: '14px', maxWidth: '400px' }}>
                Se você responder <strong>SIM</strong> para a maioria das perguntas abaixo, é muito provável que possamos acionar a Justiça para buscar o seu tratamento.
              </p>
