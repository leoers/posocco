...
const steps = [
  ...
  { 
    title: '3. Ajuizamento', 
    desc: 'Entramos com a ação judicial buscando o seu tratamento, inclusive com liminar (decisão provisória urgente).', 
  ...
  { 
    title: '5. Recebimento', 
    desc: 'Se a decisão for favorável, você recebe o tratamento, a indenização ou a medida determinada pela Justiça, conforme o seu caso.', 
  ...
  return (
    <section className="section" style={{ ...styles.section, paddingTop: isMobile ? '60px' : '120px' }}>
      <div className="container" style={styles.container}>
        <div data-aos="fade-up" style={{ textAlign: 'center', marginBottom: isMobile ? '40px' : '80px' }}>
