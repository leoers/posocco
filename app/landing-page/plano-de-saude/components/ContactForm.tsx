...
export default function ContactForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const text = `Olá! Meu nome é ${formData.nome}.%0A%0AO plano de saúde está ativo? ${formData.pergunta1}%0A%0AResumo do caso: ${formData.pergunta2}`;
  ...
  return (
    <section id="formulario" style={{ ...styles.section, paddingTop: isMobile ? '60px' : '120px' }}>
      {/* Background Image Grayscale Layer */}
      <div style={{
        position: 'absolute',
        top: 0, left: 0, width: '100%', height: '100%',
        backgroundImage: `linear-gradient(to right, rgba(4, 27, 59, 0.85), rgba(4, 27, 59, 0.6)), url('/plano-de-saude/plano-de-saude_background-formulario.jpeg')`,
      ...
      <div style={{
        position: 'absolute',
        top: 0, left: 0, width: '100%', height: '100%',
        background: `linear-gradient(to right, rgba(4, 27, 59, 0.95), rgba(4, 27, 59, 0.7))`,
        zIndex: -1,
      }} />
      <div className="container" style={{ ...styles.grid, gridTemplateColumns: isMobile ? '1fr' : 'repeat(auto-fit, minmax(320px, 1fr))', gap: isMobile ? '40px' : '80px' }}>
        ...
        <div style={styles.formContainer} data-aos="fade-left" data-aos-delay="200">
          <form onSubmit={handleSubmit}>
            ...
            <div style={styles.formGroup}>
              <label style={styles.label}>O seu plano de saúde está ativo no momento?</label>
            ...
            <div style={styles.formGroup}>
              <label style={styles.label}>Conte brevemente a sua história</label>
              <textarea required name="pergunta2" value={formData.pergunta2} onChange={handleChange} style={{ ...styles.input, height: '80px', resize: 'none' }} placeholder="EX: MEU PLANO NEGOU A CIRURGIA..."></textarea>
            </div>
