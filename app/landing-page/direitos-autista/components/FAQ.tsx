...
const faqs = [
  { q: 'O plano de saúde é obrigado a cobrir todas as terapias?', a: 'Sim, conforme entendimento consolidado, havendo prescrição médica para o tratamento de TEA, a negativa de cobertura é considerada abusiva.' },
  { q: 'O autista tem direito ao BPC/LOAS mesmo se a família tiver renda?', a: 'A análise da renda é feita de forma pormenorizada pela Justiça, considerando os custos elevados com o tratamento do autista, o que pode flexibilizar o critério de miserabilidade.' },
  { q: 'A escola pode cobrar taxa extra pelo acompanhante?', a: 'Não. É ilegal a cobrança de mensalidade adicional para disponibilizar o profissional de apoio ao aluno com TEA.' },
  { q: 'Quais documentos são necessários para a análise?', a: 'Laudo médico detalhado, prescrições de terapias, comprovantes de gastos e documentos pessoais.' },
