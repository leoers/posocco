...
const questions = [
  { 
    q: 'O seu plano de saúde negou ou limitou o número de sessões de terapias essenciais ao tratamento?', 
    a: ''
  },
  { 
    q: 'A instituição de ensino se recusa a oferecer acompanhante especializado para o aluno com TEA?', 
    a: ''
  },
  { 
    q: 'O INSS negou ou cancelou o BPC/LOAS do seu dependente, mesmo cumprindo os requisitos de baixa renda e deficiência?', 
    a: ''
  },
  { 
    q: 'Você busca entender como deduzir despesas com o tratamento e educação do dependente no Imposto de Renda e recuperar valores que não precisavam ser pagos?', 
    a: ''
  }
];
