    ...
    <section className="section" style={{ ...styles.section, paddingTop: isMobile ? '40px' : '100px' }}>
      <div className="container" style={isMobile ? styles.gridMobile : styles.grid}>
        ...
        <div className="animate-fade-up" style={{ ...styles.imageWrapper, order: isMobile ? 2 : 1 }}>
          <Image 
            src="/direitos-autista/posocco_ftg.png" 
        ...
        <div className="animate-fade-up" style={{ ...styles.textWrapper, paddingBottom: isMobile ? '0' : '100px', order: isMobile ? 1 : 2, textAlign: isMobile ? 'center' : 'left' }}>
          ...
          <ul style={{ ...styles.list, display: 'inline-flex', flexDirection: 'column', alignItems: 'flex-start', textAlign: 'left' }}>
            ...
            <li style={styles.listItem}>
              <span style={styles.dot}></span>
              Dedicação na defesa dos seus direitos no Fórum da sua cidade, nos Tribunais localizados na capital do seu estado e nos Tribunais Superiores do país, in Brasília.
            </li>
            <li style={styles.listItem}>
              <span style={styles.dot}></span>
          ...
          <div style={styles.quoteBox}>
            "Terapia negada e sessões limitadas são direitos que a lei já garante, mas que o dia a dia insiste em dificultar. Conheço esse caminho de perto. E é com esse cuidado que trato cada processo."
          </div>
        </div>
...
const styles = {
  section: {
    ...
    backgroundImage: `linear-gradient(rgba(4, 13, 26, 0.7), rgba(4, 13, 26, 0.95)), url('/assets/fundo_escriorio.png')`,
