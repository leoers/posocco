      ...
      <div className="container" style={{ ...styles.heroGrid, minHeight: isMobile ? 'auto' : 'calc(100vh - 100px)', ...(isMobile ? { ...styles.heroGridMobile, paddingBottom: '40px' } : {}) }}>
        ...
        <div className="hero-content" data-aos="fade-up" style={styles.leftCol}>
          <div style={styles.logoWrapper}>
            <Image 
              src="/direitos-autista/logo_posocco_darkbg.png" 
          ...
          <h1 className="h1" style={styles.headline}>
            Direitos e Proteção Jurídica para Pessoas com <span style={styles.highlight}>Transtorno do Espectro Autista (TEA).</span>
          </h1>
          
          <p className="text-muted" style={styles.subheadline}>
            Orientação jurídica especializada sobre negativas de tratamentos, terapias multidisciplinares e deveres das instituições de ensino.
          </p>
...
const styles = {
  ...
  bgOverlay: {
    ...
    width: '100%',
    height: '100%',
    backgroundImage: 'linear-gradient(to bottom, rgba(4, 11, 22, 0.3), rgba(4, 11, 22, 1)), url("/direitos-autista/direitos-autista_background-formulario.png")',
