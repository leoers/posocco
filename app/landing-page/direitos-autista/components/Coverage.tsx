        ...
        <div style={{ ...styles.grid, flexDirection: isMobile ? 'column' : 'row' }}>
          ...
          <div data-aos="fade-right" style={styles.leftCol}>
            <div style={styles.mapContainer}>
              <Image 
                src="/direitos-autista/brasil_mapa.png" 
                alt="Mapa do Brasil" 
                width={500}
                height={500}
...
const styles = {
  section: {
    ...
    backgroundImage: `linear-gradient(to right, rgba(4, 13, 26, 0.98), rgba(4, 13, 26, 0.92)), url('/direitos-autista/background-build.png')`,
