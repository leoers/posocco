...
const steps = [
  { 
    title: '1. Envio de Documentação', 
    desc: 'Você encaminha os documentos pessoais e laudos médicos atualizados.', 
  ...
  { 
    title: '2. Parecer Técnico', 
    desc: 'Nossa equipe realiza a análise de viabilidade do pedido.', 
  ...
  { 
    title: '3. Protocolo', 
    desc: 'Realizamos o protocolo do pedido de isenção e/ou restituição perante o órgão pagador ou Justiça.', 
  ...
  { 
    title: '5. Recebimento', 
    desc: 'Se a decisão for favorável, você passa a usufruir da isenção do Imposto de Renda e, quando cabível, pode receber a restituição dos valores pagos indevidamente.', 
