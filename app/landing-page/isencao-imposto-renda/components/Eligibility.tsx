...
const questions = [
  { 
    q: 'Você é aposentado, pensionista ou militar inativo?', 
    a: ''
  },
  { 
    q: 'Você possui diagnóstico de doença grave especificada em lei?', 
    a: '(câncer, Aids, alienação mental, cardiopatia grave, cegueira, contaminação por radiação, Paget em estados avançados, Parkinson, esclerose múltipla, espondiloartrose anquilosante, fibrose cística, hanseníase, nefropatia grave, hepatopatia grave, paralisia irreversível e incapacitante, tuberculose ativa ou moléstia profissional)'
  },
  { 
    q: 'Você ainda sofre o desconto mensal de Imposto de Renda em seu contracheque?', 
    a: ''
  },
  { 
    q: 'Você pagou imposto sobre seus proventos nos últimos 5 anos enquanto portador da patologia?', 
    a: ''
  }
];
          ...
          <div style={{ ...styles.grid, flexDirection: isMobile ? 'column' : 'row' }}>
            ...
            <div data-aos="fade-right" style={{ ...styles.leftCol, textAlign: isMobile ? 'center' : 'left', alignItems: isMobile ? 'center' : 'flex-start', order: isMobile ? 2 : 1 }}>
              ...
              <div style={{ marginTop: '32px' }}>
                <a href="#formulario" className="btn-pill" aria-label="Quero saber meus direitos">
