        ...
        <div style={{ ...styles.grid, flexDirection: isMobile ? 'column' : 'row' }}>
          ...
          <div data-aos="fade-right" style={styles.leftCol}>
            <div style={styles.mapContainer}>
              <Image 
                src="/isencao-imposto-renda/brasil_mapa.png" 
                alt="Mapa do Brasil" 
                width={500}
                height={500}
          ...
          <div data-aos="fade-left" data-aos-delay="200" style={{ ...styles.rightCol, alignItems: isMobile ? 'center' : 'flex-start', textAlign: isMobile ? 'center' : 'left' }}>
            ...
            <div style={{ marginTop: '24px' }}>
              <div style={{ ...styles.buttonWrapper, alignItems: isMobile ? 'center' : 'flex-start' }}>
                <a href="#formulario" className="btn-pill" aria-label="Quero iniciar o atendimento por WhatsApp">
...
const styles = {
  section: {
    ...
    backgroundImage: `linear-gradient(to right, rgba(4, 13, 26, 0.98), rgba(4, 13, 26, 0.92)), url('/isencao-imposto-renda/background-build.png')`,
