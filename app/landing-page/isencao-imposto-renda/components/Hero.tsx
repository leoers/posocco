      ...
      <div className="container" style={{ ...styles.heroGrid, minHeight: isMobile ? 'auto' : 'calc(100vh - 100px)', ...(isMobile ? { ...styles.heroGridMobile, paddingBottom: '40px' } : {}) }}>
        ...
        <div className="hero-content" data-aos="fade-up" style={styles.leftCol}>
          <div style={styles.logoWrapper}>
            <Image 
              src="/isencao-imposto-renda/logo_posocco_darkbg.png" 
          ...
          <h1 className="h1" style={styles.headline}>
            Isenção de IR para aposentado, pensionista e militar da reserva ou reformado com <span style={styles.highlight}>doença grave.</span>
          </h1>
          
          <p className="text-muted" style={styles.subheadline}>
            Busque o seu direito à isenção mensal e solicite a restituição dos valores retidos indevidamente nos últimos 5 anos. Assessoria jurídica especializada para aposentados, pensionistas e militares inativos.
          </p>
...
const styles = {
  ...
  bgOverlay: {
    ...
    width: '100%',
    height: '100%',
    backgroundImage: 'linear-gradient(to bottom, rgba(4, 11, 22, 0.3), rgba(4, 11, 22, 1)), url("/isencao-imposto-renda/isencao-imposto-renda_background-formulario.png")',
