...
const services = [
  {
    title: 'Isenção Mensal',
    desc: 'Cessação imediata da incidência de Imposto de Renda sobre os proventos de aposentadoria ou pensão.',
    icon: (
  ...
  {
    title: 'Restituição de Valores',
    desc: 'Recuperação legal de valores retidos indevidamente junto à Receita Federal, retroativos aos últimos 5 anos.',
    icon: (
      <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    desc: 'Análise técnica da documentação médica para verificação de enquadramento nas patologias previstas em lei.',
    icon: (
      <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    desc: 'Representação formal perante os órgãos competentes, buscando a aplicação correta da legislação vigente.',
    icon: (
      <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <section className="section" style={{ ...styles.section, paddingTop: isMobile ? '40px' : '80px' }}>
      ...
      <div className="container" style={styles.container}>
        ...
        <div data-aos="fade-up" style={styles.ctaContainer}>
            <a href="#formulario" className="btn-pill" aria-label="Quero avaliar meu caso">
