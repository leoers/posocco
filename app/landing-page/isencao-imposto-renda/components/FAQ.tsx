...
const faqs = [
  { q: 'Qual é o fundamento legal da isenção?', a: 'A isenção é prevista pela Lei 7.713/88, visando reduzir o ônus financeiro da pessoa em tratamento de saúde.' },
  { q: 'Quais doenças autorizam a isenção?', a: 'A lei prevê uma lista taxativa, incluindo neoplasias, cardiopatias graves, Parkinson, esclerose múltipla, entre outras.' },
  { q: 'Há necessidade de processo judicial?', a: 'A análise jurídica determinará se o pedido deve ser administrativo ou judicial. A assessoria especializada conduz o processo em ambas as esferas.' },
  { q: 'A isenção é definitiva?', a: 'A isenção é concedida enquanto perdurar a condição de aposentado/pensionista e as exigências legais da patologia forem atendidas.' },
