...
const faqs = [
  { q: 'Como saber se fui vítima de uma fraude bancária?', a: 'A análise de extrato de empréstimos consignados (HISCON) revela a existência de contratos não solicitados. Nossa equipe realiza essa verificação.' },
  { q: 'Posso recuperar o dinheiro descontado indevidamente?', a: 'Sim. O Código de Defesa do Consumidor prevê a repetição do indébito, muitas vezes em dobro, para cobranças indevidas.' },
  { q: 'O banco pode ser responsabilizado por empréstimo não solicitado?', a: 'Sim. As instituições financeiras possuem responsabilidade objetiva pelos danos causados por falhas na segurança de seus serviços.' },
  { q: 'Preciso cancelar minha conta para resolver?', a: 'Não necessariamente. O foco é identificar a irregularidade e buscar a reparação judicial ou administrativa dos valores descontados.' },
