...
export default function ContactForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const text = `Olá! Meu nome é ${formData.nome}.%0A%0AExtrato INSS ou contracheque: ${formData.pergunta1}%0A%0AValor aproximado descontado: ${formData.pergunta2}`;
      ...
      <div className="container" style={{ ...styles.grid, gridTemplateColumns: isMobile ? '1fr' : 'repeat(auto-fit, minmax(320px, 1fr))', gap: isMobile ? '40px' : '80px' }}>
        ...
        <div style={styles.formContainer} data-aos="fade-left" data-aos-delay="200">
          <form onSubmit={handleSubmit}>
            ...
            <div style={styles.formGroup}>
              <label style={styles.label}>O desconto aparece no seu extrato do INSS ou contracheque?</label>
            ...
            <div style={styles.formGroup}>
              <label style={styles.label}>Qual valor aproximado está sendo descontado indevidamente?</label>
              <input required type="text" name="pergunta2" value={formData.pergunta2} onChange={handleChange} style={styles.input} placeholder="R$..." />
            </div>
...
const styles = {
  section: {
    ...
    backgroundImage: `linear-gradient(to right, rgba(4, 27, 59, 0.85), rgba(4, 27, 59, 0.6)), url('/aposentado-pensionista-servidor-militar/direito-bancario_background-formulario.png')`,
