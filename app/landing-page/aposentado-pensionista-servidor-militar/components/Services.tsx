...
const services = [
  {
    title: 'Fraudes e Empréstimos Indevidos',
    desc: 'Identificação e anulação de empréstimos consignados realizados sem a sua autorização e cumprimento das normas. Direito de receber em dobro e dano moral.',
    icon: (
  ...
  {
    title: 'Descontos Irregulares',
    desc: 'Interrupção de descontos não autorizados em folha de pagamento e busca pela restituição dobrada dos valores.',
    icon: (
      <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    title: 'Venda Casada e Seguros',
    desc: 'Cancelamento de seguros e tarifas embutidas sem o seu consentimento e recuperação do saldo cobrado.',
    icon: (
      <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    title: 'Assédio Comercial',
    desc: 'Proteção contra o assédio comercial agressivo e restabelecimento da sua tranquilidade financeira.',
    icon: (
      <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    title: 'Cartão consignado (RMC/RCC)',
    desc: 'Análise da legalidade da contratação do cartão de crédito consignado (RMC/RCC), revisão de cobranças abusivas, cancelamento dos descontos indevidos e busca da restituição em dobro dos valores pagos e da indenização cabível.',
    icon: (
      <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
