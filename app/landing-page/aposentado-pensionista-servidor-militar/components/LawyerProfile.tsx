    ...
    <section className="section" style={{ ...styles.section, paddingTop: isMobile ? '40px' : '100px' }}>
      <div className="container" style={isMobile ? styles.gridMobile : styles.grid}>
        ...
        <div className="animate-fade-up" style={{ ...styles.imageWrapper, order: isMobile ? 2 : 1 }}>
          <Image 
            src="/aposentado-pensionista-servidor-militar/posocco_ftg.png" 
        ...
        <div className="animate-fade-up" style={{ ...styles.textWrapper, paddingBottom: isMobile ? '0' : '100px', order: isMobile ? 1 : 2, textAlign: isMobile ? 'center' : 'left' }}>
          ...
          <div style={styles.quoteBox}>
            "Já revisei centenas de contratos consignados de aposentados, pensionistas, servidores públicos e militares. Conheço o padrão: o valor liberado que não chega à conta, o cartão que vira dívida eterna, a portabilidade que ninguém pediu. Sei exatamente onde a fraude costuma se esconder. Isso tem solução prevista em lei."
          </div>
        </div>
...
const styles = {
  section: {
    ...
    backgroundImage: `linear-gradient(rgba(4, 13, 26, 0.7), rgba(4, 13, 26, 0.95)), url('/aposentado-pensionista-servidor-militar/fundo_escriorio.png')`,
