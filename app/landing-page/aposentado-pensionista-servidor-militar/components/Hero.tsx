      ...
      <div className="container" style={{ ...styles.heroGrid, minHeight: isMobile ? 'auto' : 'calc(100vh - 100px)', ...(isMobile ? { ...styles.heroGridMobile, paddingBottom: '40px' } : {}) }}>
        ...
        <div className="hero-content" data-aos="fade-up" style={styles.leftCol}>
          <div style={styles.logoWrapper}>
            <Image 
              src="/aposentado-pensionista-servidor-militar/logo_posocco_darkbg.png" 
          ...
          <h1 className="h1" style={styles.headline}>
            Recupere o valor dos descontos bancários indevidos do seu <span style={styles.highlight}>benefício.</span>
          </h1>
          
          <p className="text-muted" style={styles.subheadline}>
            Aposentado e pensionista do INSS, servidor público e militar na ativa, da reserva e reformado identificamos e anulamos cobranças irregulares, empréstimos não autorizados e seguros embutidos. Proteja sua renda mensal com assessoria jurídica especializada.
          </p>
...
const styles = {
  ...
  bgOverlay: {
    ...
    width: '100%',
    height: '100%',
    backgroundImage: 'linear-gradient(to bottom, rgba(4, 11, 22, 0.3), rgba(4, 11, 22, 1)), url("/aposentado-pensionista-servidor-militar/direito-bancario_background-formulario.png")',
