...
const questions = [
  { 
    q: 'Você identificou descontos no seu benefício do INSS ou contracheque que não reconhece?', 
    a: ''
  },
  { 
    q: 'Você foi vítima de empréstimo consignado realizado sem a sua solicitação ou continua pagando a dívida do cartão consignado que nunca diminui?', 
    a: ''
  },
  { 
    q: 'O banco incluiu seguros, títulos de capitalização ou tarifas sem sua autorização expressa?', 
    a: ''
  },
  { 
    q: 'Você se sente pressionado por instituições financeiras devido a dívidas ou ofertas constantes de crédito?', 
    a: ''
  }
];
