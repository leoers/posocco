      ...
      <div className="container" style={{ ...styles.heroGrid, minHeight: isMobile ? 'auto' : 'calc(100vh - 100px)', ...(isMobile ? { ...styles.heroGridMobile, paddingBottom: '40px' } : {}) }}>
        ...
        <div className="hero-content" data-aos="fade-up" style={styles.leftCol}>
          <div style={styles.logoWrapper}>
            <Image 
              src="/passageiro-aereo/logo_posocco_darkbg.png" 
          ...
          <h1 className="h1" style={styles.headline}>
            Advogados Especializados em <span style={styles.highlight}>direitos do passageiro aéreo</span>
          </h1>
          
          <p className="text-muted" style={styles.subheadline}>
            Problemas com cancelamento, atraso, overbooking ou extravio de bagagem? Atuação inteligente e estratégica focada na defesa dos seus direitos.
          </p>
...
const styles = {
  ...
  bgOverlay: {
    ...
    width: '100%',
    height: '100%',
    backgroundImage: 'linear-gradient(to bottom, rgba(4, 11, 22, 0.3), rgba(4, 11, 22, 1)), url("/passageiro-aereo/passageiro-aereo_background-formulario.jpeg")',
