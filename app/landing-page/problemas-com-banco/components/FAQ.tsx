...
const faqs = [
  { q: 'O que é considerado cobrança indevida?', a: 'Qualquer valor cobrado sem sua autorização ou sem estar previsto claramente em contrato. Você pode ter direito à devolução em dobro.' },
  { q: 'Sou vítima de golpe. Posso responsabilizar o banco?', a: 'Sim. As instituições financeiras possuem responsabilidade pela segurança das operações e, em caso de falhas ou fraudes que causem prejuízos ao cliente, podem ser obrigadas a ressarcir os valores e pagar indenizações por danos morais.' },
  { q: 'Como saber se meu contrato tem juros abusivos?', a: 'É necessária uma análise técnica das cláusulas contratuais e dos encargos cobrados para verificar se estão muito acima das taxas médias praticadas pelo mercado no mesmo período.' },
  { q: 'Demora muito para resolver?', a: 'O tempo varia de acordo com a complexidade do caso e se a solução será obtida via notificação administrativa ou ação judicial. No entanto, em situações urgentes como descontos indevidos em benefícios, solicita-se liminares para suspender as cobranças de forma imediata.' },
