      ...
      <div className="container" style={{ ...styles.heroGrid, minHeight: isMobile ? 'auto' : 'calc(100vh - 100px)', ...(isMobile ? { ...styles.heroGridMobile, paddingBottom: '40px' } : {}) }}>
        ...
        <div className="hero-content" data-aos="fade-up" style={styles.leftCol}>
          <div style={styles.logoWrapper}>
            <Image 
              src="/problemas-com-banco/logo_posocco_darkbg.png" 
          ...
          <h1 className="h1" style={styles.headline}>
            Problemas com banco? Você não precisa aceitar os abusos das <span style={styles.highlight}>grandes instituições financeiras.</span>
          </h1>
          
          <p className="text-muted" style={styles.subheadline}>
            Se você foi vítima de fraudes, golpes, juros abusivos ou descontos indevidos em sua conta bancária, busque a reparação dos prejuízos com segurança jurídica.
          </p>
...
const styles = {
  ...
  bgOverlay: {
    ...
    width: '100%',
    height: '100%',
    backgroundImage: 'linear-gradient(to bottom, rgba(4, 11, 22, 0.3), rgba(4, 11, 22, 1)), url("/problemas-com-banco/instituicao-financeira_background-formulario.jpg")',
