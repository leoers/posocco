...
export default function ContactForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const text = `Olá! Meu nome é ${formData.nome}.%0A%0AJá tentou contestar com o banco? ${formData.pergunta1}%0A%0AResumo do problema: ${formData.pergunta2}`;
      ...
      <div className="container" style={{ ...styles.grid, gridTemplateColumns: isMobile ? '1fr' : 'repeat(auto-fit, minmax(320px, 1fr))', gap: isMobile ? '40px' : '80px' }}>
        ...
        <div style={styles.formContainer} data-aos="fade-left" data-aos-delay="200">
          <form onSubmit={handleSubmit}>
            ...
            <div style={styles.formGroup}>
              <label style={styles.label}>Você já tentou contestar esse problema diretamente com o banco?</label>
            ...
            <div style={styles.formGroup}>
              <label style={styles.label}>Descreva brevemente o valor do prejuízo ou o tipo de abuso sofrido.</label>
              <textarea required name="pergunta2" value={formData.pergunta2} onChange={handleChange} style={{ ...styles.input, height: '80px', resize: 'none' }} placeholder="Sua história..."></textarea>
            </div>
...
const styles = {
  section: {
    ...
    backgroundImage: `linear-gradient(to right, rgba(4, 27, 59, 0.85), rgba(4, 27, 59, 0.6)), url('/problemas-com-banco/instituicao-financeira_background-formulario.jpg')`,
