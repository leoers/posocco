...
const questions = [
  { 
    q: 'Identificou cobranças, tarifas ou descontos em sua conta ou benefício que não reconhece ou não autorizou?', 
    a: ''
  },
  { 
    q: 'Seus dados foram usados por terceiros para abertura de contas, compras ou contratação de empréstimos consignados em seu nome?', 
    a: ''
  },
  { 
    q: 'Possui contrato de financiamento ou empréstimo com taxa de juros muito acima da média de mercado divulgada pelo Banco Central para aquela modalidade?', 
    a: ''
  },
  { 
    q: 'O banco realizou descontos diretamente no seu salário ou aposentadoria que comprometeram seu sustento mínimo?', 
    a: ''
  }
];
