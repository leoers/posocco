    ...
    <section className="section" style={{ ...styles.section, paddingTop: isMobile ? '40px' : '100px' }}>
      <div className="container" style={isMobile ? styles.gridMobile : styles.grid}>
        ...
        <div className="animate-fade-up" style={{ ...styles.imageWrapper, order: isMobile ? 2 : 1 }}>
          <Image 
            src="/acidente-de-trabalho/posocco_ftg.png" 
        ...
        <div className="animate-fade-up" style={{ ...styles.textWrapper, paddingBottom: isMobile ? '0' : '100px', order: isMobile ? 1 : 2, textAlign: isMobile ? 'center' : 'left' }}>
          ...
          <div style={styles.quoteBox}>
            "Enquanto você se recupera, alguém precisa acompanhar cada direito que esse acidente gerou: o benefício do INSS, a estabilidade no emprego e a eventual indenização. Esse é o meu papel na sua defesa."
          </div>
        </div>
...
const styles = {
  section: {
    ...
    backgroundImage: `linear-gradient(rgba(4, 13, 26, 0.7), rgba(4, 13, 26, 0.95)), url('/acidente-de-trabalho/fundo_escriorio.png')`,
