...
const questions = [
  { 
    q: 'Você sofreu uma lesão no trabalho ou foi diagnosticado com uma doença causada ou agravada pelas suas funções?', 
    a: ''
  },
  { 
    q: 'A empresa deixou de pagar seus medicamentos, tratamentos ou parou de recolher seu FGTS enquanto você está afastado?', 
    a: ''
  },
  { 
    q: 'Você ficou com sequelas físicas, estéticas ou limitações que prejudicam sua capacidade de trabalhar?', 
    a: ''
  },
  { 
    q: 'Está enfrentando dificuldades para conseguir ou manter o benefício correto junto ao INSS?', 
    a: ''
  }
];
