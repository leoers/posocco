...
const services = [
  {
    title: 'Auxílios e Benefícios do INSS',
    desc: 'Suporte especializado para concessão ou revisão de auxílio-doença, auxílio-acidente (independente da data do acidente), aposentadoria por incapacidade permanente ou pensão por morte.',
    icon: (
  ...
  {
    title: 'Direitos Trabalhistas & FGTS',
    desc: 'Exigência do recolhimento obrigatório do seu FGTS durante todo o período de afastamento pelo INSS e proteção do seu emprego através da estabilidade legal.',
    icon: (
      <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    desc: 'Ações para reparação financeira por danos morais (sofrimento e abalo), estéticos (cicatrizes e marcas) ou materiais (perda financeira e lucros cessantes).',
    icon: (
      <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    title: 'Restituição de Gastos Médicos',
    desc: 'Cobrança e reembolso integral de tudo o que você gastou com medicamentos, próteses, exames e tratamentos médicos por conta do acidente ou doença.',
    icon: (
      <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
