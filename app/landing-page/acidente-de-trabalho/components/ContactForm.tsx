...
export default function ContactForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const text = `Olá! Meu nome é ${formData.nome}.%0A%0ARecebe auxílio do INSS? ${formData.pergunta1}%0A%0ALesões/Gastos médicos/FGTS: ${formData.pergunta2}`;
      ...
      <div className="container" style={{ ...styles.grid, gridTemplateColumns: isMobile ? '1fr' : 'repeat(auto-fit, minmax(320px, 1fr))', gap: isMobile ? '40px' : '80px' }}>
        ...
        <div style={styles.formContainer} data-aos="fade-left" data-aos-delay="200">
          <form onSubmit={handleSubmit}>
            ...
            <div style={styles.formGroup}>
              <label style={styles.label}>Você já deu entrada ou recebe algum auxílio do INSS (como auxílio-doença ou auxílio-acidente)?</label>
            ...
            <div style={styles.formGroup}>
              <label style={styles.label}>Conte brevemente quais foram suas lesões/gastos médicos e se a empresa recolheu seu FGTS:</label>
              <textarea required name="pergunta2" value={formData.pergunta2} onChange={handleChange} style={{ ...styles.input, height: '80px', resize: 'none' }} placeholder="Descreva aqui sua história..."></textarea>
            </div>
...
const styles = {
  section: {
    ...
    backgroundImage: `linear-gradient(to right, rgba(4, 27, 59, 0.85), rgba(4, 27, 59, 0.6)), url('/acidente-de-trabalho/direitos-trabalhador_background-formulario.png')`,
