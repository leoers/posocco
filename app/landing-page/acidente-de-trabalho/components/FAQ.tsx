...
const faqs = [
  { q: 'O que o empregador deve pagar em caso de acidente ou doença ocupacional?', a: 'A empresa é responsável por custear todo o tratamento médico (medicamentos, exames, próteses) e deve continuar recolhendo o seu FGTS normalmente durante o período de afastamento previdenciário.' },
  { q: 'Quais indenizações posso receber além do benefício do INSS?', a: 'Você pode exigir indenizações por danos morais (pela dor e abalo psicológico), danos estéticos (caso fiquem cicatrizes ou deformidades) e danos materiais (pela perda da capacidade de trabalho ou gastos gerados).' },
  { q: 'Eu tenho direito à estabilidade no emprego?', a: 'Sim. O trabalhador que sofre acidente de trabalho ou desenvolve doença ocupacional e se afasta pelo INSS tem direito à estabilidade provisória de, no mínimo, 12 meses após o retorno às atividades.' },
  { q: 'Quais são os auxílios do INSS que posso ter direito?', a: 'Dependendo da gravidade, você pode ter direito ao auxílio-doença (incapacidade temporária), auxílio-acidente (indenização por sequela que reduz a capacidade), aposentadoria por incapacidade permanente (invalidez) ou, em caso de fatalidade, a pensão por morte para os dependentes.' },
