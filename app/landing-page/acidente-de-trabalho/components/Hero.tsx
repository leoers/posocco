      ...
      <div className="container" style={{ ...styles.heroGrid, minHeight: isMobile ? 'auto' : 'calc(100vh - 100px)', ...(isMobile ? { ...styles.heroGridMobile, paddingBottom: '40px' } : {}) }}>
        ...
        <div className="hero-content" data-aos="fade-up" style={styles.leftCol}>
          <div style={styles.logoWrapper}>
            <Image 
              src="/acidente-de-trabalho/logo_posocco_darkbg.png" 
          ...
          <h1 className="h1" style={styles.headline}>
            Sofreu Acidente de Trabalho ou Doença Ocupacional? <span style={styles.highlight}>Conheça os seus Direitos.</span>
          </h1>
          
          <p className="text-muted" style={styles.subheadline}>
            Orientação especializada para buscar os seus direitos decorrentes de acidentes ou doenças relacionadas ao trabalho.
          </p>
...
const styles = {
  ...
  bgOverlay: {
    ...
    width: '100%',
    height: '100%',
    backgroundImage: 'linear-gradient(to bottom, rgba(4, 11, 22, 0.3), rgba(4, 11, 22, 1)), url("/acidente-de-trabalho/direitos-trabalhador_background-formulario.png")',
