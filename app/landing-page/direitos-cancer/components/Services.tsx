...
const services = [
  {
    ...
    desc: 'Pedido de liminar para início imediato de terapias, cirurgias e fornecimento de medicamentos de alto custo pelo plano de saúde ou SUS.',
    icon: (
  ...
  {
    title: 'Direitos Trabalhistas e Previdenciários',
    desc: 'Proteção contra demissões arbitrárias, defesa de estabilidade e suporte na concessão de auxílios e aposentadoria por incapacidade.',
    icon: (
      <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    desc: 'Assessoria para obtenção de isenções de Imposto de Renda, IPVA, IPI e outros benefícios tributários previstos em lei.',
    icon: (
      <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    desc: 'Orientação para acesso ao BPC/LOAS e prioridade de tramitação em processos administrativos e judiciais.',
    icon: (
      <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    title: 'Liquidação de contrato de financiamento imobiliário',
    desc: 'Assessoria para obtenção da quitação do financiamento habitacional nos casos previstos em lei e no contrato, incluindo situações de invalidez permanente, morte ou cobertura pelo seguro habitacional. E suporte para contestar negativas indevidas do banco ou da seguradora.',
    icon: (
      <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
