      ...
      <div className="container" style={{ ...styles.heroGrid, minHeight: isMobile ? 'auto' : 'calc(100vh - 100px)', ...(isMobile ? { ...styles.heroGridMobile, paddingBottom: '40px' } : {}) }}>
        ...
        <div className="hero-content" data-aos="fade-up" style={styles.leftCol}>
          <div style={styles.logoWrapper}>
            <Image 
              src="/direitos-cancer/logo_posocco_darkbg.png" 
          ...
          <h1 className="h1" style={styles.headline}>
            Direitos da Pessoa com Câncer: Proteção Jurídica para o seu <span style={styles.highlight}>Tratamento e Bem-Estar.</span>
          </h1>
          
          <p className="text-muted" style={styles.subheadline}>
            Orientação jurídica especializada sobre negativas de tratamento pelo plano de saúde ou SUS, direitos previdenciários e isenções de impostos.
          </p>
...
const styles = {
  ...
  bgOverlay: {
    ...
    width: '100%',
    height: '100%',
    backgroundImage: 'linear-gradient(to bottom, rgba(4, 11, 22, 0.3), rgba(4, 11, 22, 1)), url("/direitos-cancer/direitos-cancer_background-formulario.png")',
