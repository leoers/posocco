...
const questions = [
  { 
    q: 'O seu plano de saúde negou ou atrasou a liberação de exames, medicamentos ou tratamentos oncológicos?', 
    a: ''
  },
  { 
    q: 'Você teve dificuldades para acessar os benefícios previdenciários ou sofreu restrições no ambiente de trabalho devido ao diagnóstico?', 
    a: ''
  },
  { 
    q: 'Você quer saber se pode ter direito a isenções de impostos (como Imposto de Renda, IPVA ou IPI) previstos em lei para pacientes com câncer?', 
    a: ''
  },
  { 
    q: 'Você acredita que pode ter direito à quitação do seu financiamento imobiliário e não sabe como solicitar esse benefício?', 
    a: ''
  }
];
